    ...
    <div className="container mx-auto max-w-4xl py-12 px-4">
      <Card>
        ...
        <CardContent className="space-y-4 text-muted-foreground">
          <p>
            Welcome to Roast-My-Code, the only corner of the internet where your code's feelings are not a priority. My mission is to inject a lethal dose of humor into the caffeine-fueled, sleep-deprived world of software development.
          </p>
          <p>
